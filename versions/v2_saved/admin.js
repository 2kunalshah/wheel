(function () {
  ...
  function hydrateForm() {
    ...
    refs.publicUrl.value = config.publicUrl || `${window.location.origin}${window.location.pathname.replace("admin.html", "index.html")}`;
  ...
  function exportLeads() {
    ...
    a.href = url;
    a.download = `trade-show-leads-${new Date().toISOString().slice(0, 10)}.csv`;
